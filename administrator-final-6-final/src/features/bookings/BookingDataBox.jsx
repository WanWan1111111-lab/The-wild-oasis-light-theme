...
function BookingDataBox({ booking }) {
  const {
    ...
    observations,
    isPaid,
    guests: { fullName: guestName, email, country, countryFlag, national_id },
  ...
  return (
    <StyledBookingDataBox>
      ...
      <Footer>
        <p>预订时间 {format(new Date(created_at), "EEE, MMM dd yyyy, p")}</p>
      </Footer>
    </StyledBookingDataBox>
  );
}
